      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          if(query_pairs.containsKey("num1") & query_pairs.containsKey("num2")){
            ...
            //Get both arguments
            String stringNum1 = query_pairs.get("num1");
            String stringNum2 = query_pairs.get("num2");

            //attempt to convert string to int and do math
            try {
              ...
              builder.append("Content-Type: text/html; charset=utf-8\n");
              builder.append("\n");
              builder.append("Arguments num1 and num2 require two integers.\n");
              builder.append("\n");
              builder.append("Example: multiply?num1=4&num2=4");
            }

            //Fail condition for incorrect arguments.
          } else{
            builder.append("HTTP/1.1 400 Bad Request\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Multiply requires two parameters, num1=[Value] and num2=[Value].\n");
            builder.append("\n");
            builder.append("Example: multiply?num1=4&num2=4");
