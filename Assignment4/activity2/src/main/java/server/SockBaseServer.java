...
class SockBaseServer implements Runnable {
                ...
                switch (request.getOperationType()) {
                    ...
                    case ROWCOL:
                        ...
                        if (game.hasValidLocation(row, column)) {
                            ...
                            // Win condition
                            if (game.getIdx() == game.getIdxMax()) {   // won condition
    ...
    private synchronized Response buildWonRes() {
        return Response.newBuilder().setResponseType(ResponseType.WON).setImage(game.getImage()).setMessage("All Battleships have been destroy!!!").build();
    }
